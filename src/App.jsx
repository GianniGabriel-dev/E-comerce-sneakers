...
function App() {
  ...
  useEffect(() => {
    ...
    const newCartCount = cart.reduce(
    ...
    <>
      <header>
        ...
        <button className="menu-toggle" onClick={() => setMenuOpen(!menuOpen)}>
          {" "}
          {/*Boton que aparece con css para hacer la pagina responive, al hacer click, se pasa el estado contario al que tenga*/}
          {menuOpen ? "✖" : "☰"}
        </button>
        <nav className={menuOpen ? "open" : ""}>
          {" "}
          {/*Cuando menuOpen sea true se le añade la clase open, y en el css se edita  */}
          <NavLink
            to="/"
